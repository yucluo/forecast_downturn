...
### extract source newspaper name ------

# keep only strings before the comma and ;
...
### clean up rating newspaper name -----
...
### manually equate paper names 
sources$PaperName = plyr:: revalue(sources$PaperName, c("hollywoodreporter.com" = "hollywood reporter"))
...
# see how many are not matched
prop.table(table(joined_df_1$bias_rating, useNA = "always"))
knitr::kable(prop.table(table(joined_df_1$bias_rating, useNA = "always")))
